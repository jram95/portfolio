              ...
              <Nav>
                <Nav.Link as={Link} to="/blog">
                  <img
                    ...
                    src="blog.png"
                    alt="front page of simple blog"
                  />
                </Nav.Link>
              </Nav>
              <div className="caption">
                <h3 style={{ textAlign: "center" }}>Next.js Blog</h3>
                <p>Introduction to Next.js through a blog tutorial.</p>
                <p>
                  <Nav>
                    <Nav.Link
                      style={{
          ...
          >
            <div className="thumbnail">
              ...
              <div className="caption">
                ...
                <p>
                  Solo "passion project". Inspired by the connecting wall in
                  Only Connect.
                </p>
                <p>
                  <Nav>
          ...
          >
            <div className="thumbnail">
              ...
              <div className="caption">
                ...
                <p>
                  Built during a 3-week sprint in a 4 person team at Academy.
                </p>
                <p>
                  <Nav>
                    <Nav.Link
